...
export function HeroChartCaption() {
  return (
    <div
      className="pointer-events-none absolute inset-x-0 bottom-0 z-10 bg-gradient-to-t from-[#2a2433] via-[#2a2433]/85 to-transparent px-5 pb-4 pt-16 sm:px-6 sm:pb-5 lg:px-10 lg:pb-6 lg:pt-20"
      aria-hidden
    >
      <p className="mx-auto max-w-xl text-center text-[0.6875rem] leading-relaxed text-white/55 sm:max-w-2xl sm:text-xs lg:mx-0 lg:max-w-md lg:text-left lg:text-sm lg:leading-relaxed">
        Aun con{" "}
