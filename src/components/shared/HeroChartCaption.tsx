...
export function HeroChartCaption() {
  return (
    <div
      className="pointer-events-none absolute inset-x-0 bottom-0 z-10 bg-gradient-to-t from-[#2a2433] via-[#2a2433]/75 to-transparent px-5 pb-4 pt-10 sm:px-6 sm:pb-5 lg:px-10 lg:pb-6 lg:pt-14"
      aria-hidden
    >
