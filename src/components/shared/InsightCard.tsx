...
export function InsightCard({ item, compact = false }: InsightCardProps) {
  return (
    <Link
      ...
      className="card-hover group flex w-full gap-5 rounded-2xl border border-xinergy-charcoal/10 bg-white p-5 transition sm:gap-6 sm:p-6 lg:gap-8 lg:p-8"
    >
      <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl bg-xinergy-cream sm:h-20 sm:w-20 lg:h-24 lg:w-24">
        <InsightIcon
          icon={item.icon}
      ...
      <div className="min-w-0 flex-1">
        ...
        <h2
          className={`mt-2 font-semibold leading-snug text-xinergy-charcoal group-hover:text-xinergy-orange ${
